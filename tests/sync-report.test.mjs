...
describe('buildSyncReport', () => {
  it('shows names and the partial-scan protection message', () => {
    const report = buildSyncReport({
      ...
      syncState: {
        ...
        scope: { complete: false, stopReason: 'product-limit' },
        summary: { new: 1, updated: 1, restored: 0, removed: 0, unobserved: 1 },
        changes: { new: ['p_d'], updated: ['p_a'], restored: [], removed: [], unobserved: ['p_b'] }
      }
    });
  ...
  it('uses the previous catalog name for a confirmed removal', () => {
    const report = buildSyncReport({
      ...
      afterCatalog,
      syncState: {
        scope: { complete: true, stopReason: 'empty-page' },
        summary: { new: 0, updated: 0, restored: 0, removed: 1, unobserved: 0 },
        changes: { new: [], updated: [], restored: [], removed: ['p_c'], unobserved: [] }
      }
    });
